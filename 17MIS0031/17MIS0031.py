...
new_data.to_csv(r'ID\MFC.csv',index=False)

first_and_second_min_prices = pd.read_csv(r"ID\MFC.csv")
...
temp_data.to_csv(r'ID\ID_Lowest_Price.csv',index_label="SKU")
df = pd.read_csv(r"ID\ID_Lowest_Price.csv")
